...
const defaultIcon = 'wi-owm-501'

export default (data, withDayNight = false) => {
  let dayNight = ''
  if (withDayNight) dayNight = data.icon.slice(-1) === 'n' ? '-night' : '-day'
  return icons[`wi-owm${dayNight}-${data.id}`] || defaultIcon
}
